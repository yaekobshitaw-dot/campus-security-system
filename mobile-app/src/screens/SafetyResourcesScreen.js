...
const styles = StyleSheet.create({ container: { flex: 1, backgroundColor: '#F4F8F7' }, content: { padding: 20, paddingBottom: 35 }, title: { color: '#17313A', fontSize: 27, fontWeight: '700' }, intro: { marginTop: 8, marginBottom: 22, color: '#6E7C7F', fontSize: 14, lineHeight: 20 }, card: { marginBottom: 12, padding: 17, borderRadius: 14, backgroundColor: '#FFF', borderWidth: 1, borderColor: '#DCE9E5', elevation: 1 }, cardHeading: { flexDirection: 'row', alignItems: 'center', gap: 10 }, icon: { alignItems: 'center', justifyContent: 'center', width: 38, height: 38, borderRadius: 11, backgroundColor: '#E6F3EF' }, heading: { color: '#116B5F', fontSize: 16, fontWeight: '700' }, text: { marginTop: 10, color: '#657276', fontSize: 13, lineHeight: 20 } });
